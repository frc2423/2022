...
public class Devices {
    ...
    public static DigitalInput leftLimitSwitchClimber = new DigitalInput(1); // needs actual ports
    public static DigitalInput rightLimitSwitchClimber = new DigitalInput(0);
