...
public class ShootTwoPlayerStation extends StateMachine {
    ...
    @RunState(name = "HubToPlayerStation")
    public void HubToPlayerStation() {
        Subsystems.follower.follow();
        if (Subsystems.follower.isDone()) {
            setState("Intake");
        }
